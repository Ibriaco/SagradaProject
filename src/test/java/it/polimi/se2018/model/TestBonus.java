...
public class TestBonus {
    ...
    public void testLightShades(){
        ...
        g.getPublicCards().add(0, new LightShade( "LightShades", "a", 2 ));
    ...
    public void testMediumShades(){
        ...
        g.getPublicCards().add(0, new MediumShade("MediumShades", "a", 2 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testDeepShades(){
        ...
        g.getPublicCards().add(0, new DeepShade("DeepShade", "Sets of one of each color anywhere", 2 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testColorVariety(){
        ...
        g.getPublicCards().add(0, new ColorBonus("ColorVariey", "Sets of one of each color anywhere", 4 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testShadeVariety(){
        ...
        g.getPublicCards().add(0, new Shade("ShadeVariety", "Sets of one of each color anywhere", 5 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testColumnShadeVariety(){
        ...
        g.getPublicCards().add(0, new ColumnShade("ColumnShadeVariety", "Sets of one of each color anywhere", 4 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testRowShadeVariety(){
        ...
        g.getPublicCards().add(0, new RowShade("RowShadeVariety", "Sets of one of each color anywhere", 5 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testRowColorVariety(){
        ...
        g.getPublicCards().add(0, new RowColor("RowColorVariety", "Sets of one of each color anywhere", 6 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testColumnColorVariety(){
        ...
        g.getPublicCards().add(0, new ColumnColor("ColumnColorVariety", "Sets of one of each color anywhere", 5 ));
        g.getPublicCards().get(0).calculateBonus(p);
    ...
    public void testColorDiagonals(){
        ...
        g.getPublicCards().add(0, new ColorDiagonals("ColorDiagonals", "Sets of one of each color anywhere", 0 ));
        g.getPublicCards().get(0).calculateBonus(p);
