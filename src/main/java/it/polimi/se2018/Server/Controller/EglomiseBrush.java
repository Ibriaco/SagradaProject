...
//Muovi  un  qualsiasi  dado  nella  tua  vetrata  ignorando  le  restrizioni  di  coloreDevi  rispettare
...
public class EglomiseBrush extends ToolCard {
    ...
    protected void applyEffect(Player p, Die d, PlaceDieEvent placeDieE, int x, int y){
